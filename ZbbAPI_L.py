...
def test_make():
    ...
    twoD = TwoDAlphabet(working_area, '/afs/cern.ch/work/m/mrogulji/UL_X_YH/Zbb_SF/CMSSW_10_6_14/src/2DAlphabet/configs/2016/ZbbConfig_L.json', loadPrevious=False)
...
if __name__ == '__main__':
    ...
    working_area = 'Zbbfit_L'
    #test_make()

    # for order in ["0x0","0x1","1x0","1x1","1x2","2x1","2x2","2x3","3x2"]:
    #     polyOrder = order
    #     test_fit()
